...
/usr/bin/env -i \
	...
	\
	/bin/bash --rcfile <(cat ~/.bashrc ; echo 'PS1="\[\033[0;33m\][native $CROSSPI_BUILD_ARCH]\[\033[00m\] $PS1"' ; echo 'alias cross=$CROSSPI_HOME/cross-env.sh' ; echo $1) +h
